...
?>
<main>
<section class="stageart-hero"><div class="stageart-container stageart-hero-copy"><h1><?php echo esc_html($org);?></h1><?php if($desc):?><p class="stageart-hero-description"><?php echo esc_html($desc);?></p><?php endif;?></div></section>
<?php foreach($sections as $section):$id='';if($section['heading']==='公演')$id='productions';elseif($section['heading']==='私たちについて')$id='about';elseif($section['heading']==='メンバー')$id='members';elseif($section['heading']==='劇団代表挨拶')$id='representative-greeting';elseif($section['heading']==='お知らせ')$id='news';?>

...
?>
<main>
<?php $hero=get_option('stageart_core_hero',[]); if(!is_array($hero))$hero=[]; $heroTitle=trim((string)($hero['title']??'')); $heroDescription=trim((string)($hero['description']??'')); if($heroTitle==='')$heroTitle=$org; if($heroDescription==='')$heroDescription=$desc; if(!empty($hero['enabled'])): ?><section class="stageart-hero"><div class="stageart-container stageart-hero-copy"><h1><?php echo esc_html($heroTitle);?></h1><?php if($heroDescription):?><p class="stageart-hero-description"><?php echo esc_html($heroDescription);?></p><?php endif;?></div></section><?php endif; ?>

        ...
        echo '<script>(function(){
            ...
            function wire(sec){
                ...
                sec.querySelectorAll(".sa-pl-slot").forEach(function(row){
                    ...
                    const toggle=function(){const heading=t.value==="heading";c.style.display=heading?"none":"inline-block";h.style.display=heading?"inline-block":"none"};

...
final class PerformanceDisplayAdmin
{
    ...
    public function footer(): void
    {
        ...
        if(perf&&!f.querySelector(".stageart-performance-display-setting")){const b=document.createElement("div");b.className="stageart-performance-display-setting";b.innerHTML="<strong>公演スケジュールの表示方式</strong> "+sel("performance_view",[["table","表形式"],["list","一覧形式"],["timeline_line","タイムライン（線）"],["timeline_grid","タイムライン（区切り）"]],"' . $v . '")+"　<strong>サイズ</strong> "+sel("performance_size",[["l","L"],["m","M"],["s","S"]],"' . $ps . '");perf.parentNode.insertBefore(b,perf)}

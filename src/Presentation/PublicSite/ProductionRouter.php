...
final class ProductionRouter
{
    ...
    {
        echo '<style>.stageart-performance-table--compact th,.stageart-performance-table--compact td{padding:5px 7px;font-size:.82rem;line-height:1.25}.stageart-performance-table--compact{min-width:0}.stageart-performance-list{font-size:.95rem}.stageart-performance-list-row{display:flex;align-items:baseline;gap:18px;padding:7px 0;border-bottom:1px solid var(--line)}.stageart-performance-list-date{min-width:55px;font-weight:600}.stageart-performance-list-time{letter-spacing:.03em}.stageart-performance-timeline{overflow:auto}.stageart-performance-timeline table{width:100%;border-collapse:collapse;table-layout:fixed;min-width:480px}.stageart-performance-timeline th,.stageart-performance-timeline td{text-align:center;padding:6px 4px;font-size:.85rem}.stageart-performance-timeline thead th{font-weight:500;padding-bottom:8px}.stageart-performance-timeline tbody th{width:62px;font-weight:500;white-space:nowrap}.stageart-performance-timeline-line{position:relative;display:flex;align-items:center;justify-content:center;min-height:27px}.stageart-performance-timeline-line:before{content:"";position:absolute;left:0;right:0;top:50%;border-top:2px solid var(--line)}.stageart-performance-timeline-line b{position:relative;z-index:1;font-weight:500;background:var(--paper);padding:0 5px;line-height:1.2}.stageart-performance-timeline--grid td{border-left:1px solid var(--line);border-top:1px solid var(--line)}.stageart-performance-timeline--grid tr:last-child td{border-bottom:1px solid var(--line)}.stageart-performance-timeline--grid th{border-top:1px solid var(--line)}.stageart-performance-timeline--grid thead th{border-top:0}.stageart-performance-timeline--grid td:last-child{border-right:1px solid var(--line)}.stageart-performance-timeline--grid .stageart-performance-timeline-line:before{border-top:1px solid var(--line)}@media(max-width:520px){.stageart-performance-list-row{gap:10px}.stageart-performance-list-date{min-width:45px}.stageart-performance-timeline table{min-width:400px}}</style>';
